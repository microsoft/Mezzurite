(function (global, factory) {
    ...
    var MezzuriteUtils = /** @class */ (function () {
        ...
        MezzuriteUtils.addCustomEventPolyfill = function () {
    ...
    var PerformanceTimingService = /** @class */ (function () {
        ...
        PerformanceTimingService.calculateSlowestResourceBatch = function () {
            var elementDict = window.mezzurite.elementLookup;
            for (var prop in elementDict) {
                var slow = this.calculateSlowestResource(elementDict[prop], prop);
                if (slow === null) {
    ...
    var PerformanceTelemetryService = /** @class */ (function () {
        ...
        PerformanceTelemetryService.submitTelemetry = function (isRedirect) {
            ...
            if (window.mezzurite.elementLookup !== {}) {
